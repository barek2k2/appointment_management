...
class ClinicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clinic" do
    assert_difference("Clinic.count") do
      post clinics_url, params: { clinic: { location: @clinic.location, name: @clinic.name } }
    end
  ...
  test "should update clinic" do
    patch clinic_url(@clinic), params: { clinic: { location: @clinic.location, name: @clinic.name } }
